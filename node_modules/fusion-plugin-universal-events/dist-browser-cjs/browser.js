...
var _inMemory = require("./storage/in-memory");
...
const plugin = true && (0, _fusionCore.createPlugin)({
  deps: {
    ...
    storage: _index.UniversalEventsBatchStorageToken.optional
  },
  provides: ({
    fetch,
    storage
  }) => {
    return new UniversalEmitter(fetch, storage || _inMemory.inMemoryBatchStorage);
  },
